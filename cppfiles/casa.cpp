...
Casa::Casa(int _codigo, int _cantAmbiente, int _cantDormitorios, int _cantBanios, float _m2Edificios, DTDir * dir, bool _tieneGaraje, int codZona, char* letraDep, float _m2Verdes, int cantCon, DTInmobiliaria* inmo): Propiedad(_codigo, _cantAmbiente, _cantDormitorios, _cantBanios, _m2Edificios, inmo, dir, _tieneGaraje, cantCon, letraDep, codZona){
